...
const Hero = () => {
  return (
    <div className="flex flex-col p-3 md:px-8 lg:px-10 md:flex-row md:items-center w-full">
      <div className="relative w-full mb-4 md:mr-5 h-[300px] md:w-4/6 md:h-[400px] bg-gray-300 rounded-[15px]">
      ...
      <div className="text-left flex flex-col pb-5 md:justify-start md:w-2/6 md:h-[400px]">
